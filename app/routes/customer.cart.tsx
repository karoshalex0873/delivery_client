    ...
    if (checkoutSuccess) {
      return (
        <div className="flex min-h-[60vh] flex-col items-center justify-center space-y-4 text-center animate-fade-in">
          <div className="flex h-20 w-20 items-center justify-center rounded-full bg-green-50 text-green-600 shadow-xl shadow-green-100 ring-4 ring-white">
      ...
      <div className="overflow-hidden rounded-3xl border border-border bg-surface shadow-sm">
        ...
        <div className="border-t border-border bg-surface-hover/20 p-6">
          ...
          {shippingQuote?.distanceKm != null ? (
            <p className="mb-3 text-xs text-muted-foreground">Distance: {shippingQuote.distanceKm.toFixed(1)} km</p>
          ) : (
            <div className="mb-3" />
          )}
